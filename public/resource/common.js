...
$(document).ready(function(){
 ...
 $('#contents').fullpage({
    ...
    navigation: true,
      ...
      navigationTooltips: ['MAIN', 'Recent Articles','Footer'],
    showActiveTooltip: true,
    sectionsColor: ['#fff','#f1ecec']
  });
...
function slideNav_init(){
  var $menuBtn = $('.slideOpenClose');
var $slideNav = $('header > div.slide-nav-wrap');
...
$menuBtn.click(slideNavOpenClose);
}
